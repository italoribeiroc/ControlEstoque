    ...
    ui(new Ui::fm_novavenda)
{
    ...
    ui->tw_listaprodutos->setColumnWidth(0,135);
    ui->tw_listaprodutos->setColumnWidth(1,260);
    ui->tw_listaprodutos->setColumnWidth(2,131);
    ui->tw_listaprodutos->setColumnWidth(3,131);
    ui->tw_listaprodutos->setColumnWidth(4,131);
...
void fm_novavenda::on_btn_excluirproduto_clicked()
{
    if(ui->tw_listaprodutos->currentColumn()!=-1){
        QMessageBox::StandardButton opc=QMessageBox::question(this,"Exlusão?","Confirma exclusão do produto?",QMessageBox::Yes|QMessageBox::No);
...
void fm_novavenda::on_btn_finalizarvenda_clicked()
{
    if(ui->tw_listaprodutos->rowCount()>0){
        ...
        if(!query.exec()){
            ...
            //armazenar dados produtos vendidos
